...
public interface IJob {
    protected static readonly BodyPartGroup[] DefaultBodyPartGroups = [ BodyPartGroup.Variable(1, 3, BodyPartType.Carry, BodyPartType.Work), BodyPartGroup.Fixed(1, BodyPartType.Move) ];
