...
public class MenuVisualizer : IManager {
    private static readonly RectVisualStyle MenuBarBackground = new(Fill: Color.Black, Opacity: 0.5);
    private static readonly TextVisualStyle MenuBarText = new(Stroke: Color.White, StrokeWidth: 0.01,Align: TextAlign.Left, Color: ColorGolden);
    private static readonly LineVisualStyle MenuBarLine = new(Color: ColorGolden);
    ...
    public MenuVisualizer(RoomCache room, CreepManager creepManager) {
        _room = room;
